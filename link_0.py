...
class link:
	...
	def __init__(self,vertices:[vertice, vertice],place):
		self.vertices = vertices
		self.place = place #inside or on the membrane
		# Initial lenght
	...
	# New print function
	def __repr__(self):
		return "link: vertices({}), place({}), activity({})".format(
			self.vertices, self.place, self.activity)
